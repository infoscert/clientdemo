...
class ResConfigSettings(models.TransientModel):
    ...
    store_user_ids = fields.Many2many(related='company_id.store_user_ids', string='Store Officer', readonly=False)
    ...
    facility_manager_id = fields.Many2one(related='company_id.facility_manager_id', string='Facility Manager', readonly=False)
    ...
    general_manager_id = fields.Many2one(related='company_id.general_manager_id', string='CEO', readonly=False)
