...
class ResCompany(models.Model):
    ...
    store_user_ids = fields.Many2many('res.users', 'store_company_rel', string='Store Officer')
    ...
    general_manager_id = fields.Many2one('res.users', string='CEO')
    ...
    treasury_users_ids = fields.Many2many('res.users', 'treasury_users_rel', string='Treasury')
    cfo_id = fields.Many2one('res.users', string='CFO')
    eds_bank_ids = fields.Many2many('res.users', 'eds_bank_users_rel', string='EDs')